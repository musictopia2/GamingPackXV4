...
public static class MiscGraphicExtensions
{
    ...
    {
        public void DrawPawnPiece(RectangleF rectangle, string customColor)
        {
            SVG svg = new();
        ...
        public void DrawDice(RectangleF rectangle, int value)
        {
            Image image = new();
    ...
    extension (ISvg svg)
    {
        public void DrawPawnPiece(string customColor)
        {
            Path path = new()
            {
    ...
    extension (IParentContainer parent)
    {
        public void DrawStar(RectangleF bounds, string solidColor, string borderColor, float borderSize)
        {
            var svg = new SVG();
        ...
        public void DrawSmiley(RectangleF rectangle, string solidColor, string borderColor, string eyeColor, float borderSize) //i think
        {
