...
public static class SuitExtensions
{
    ...
    {
        public void DrawCardSuit(EnumSuitList suit, float x, float y, float width, float height, string color)
        {
            RectangleF rect = new(x, y, width, height);
            parent.DrawCardSuit(suit, rect, color);
        }
        public void DrawRoyalSuits(RectangleF rectangle, string fillColor, string borderColor = "", int borderSize = 0)
        {
            SVG svg = new ();
        ...
        public void DrawCardSuit(EnumSuitList suit, RectangleF rectangle, string color)
        {
            if (suit == EnumSuitList.Clubs)
            {
                parent.DrawClubs(rectangle, color);
                return;
            }
            SVG svg;
        ...
        private void DrawClubs(RectangleF rectangle, string color)
        {
            SVG svg = new ()
            {
                ViewBox = "0 0 400 400"
