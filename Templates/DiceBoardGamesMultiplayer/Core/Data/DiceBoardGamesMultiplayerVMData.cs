...
[SingletonGame]
[UseLabelGrid]
public partial class DiceBoardGamesMultiplayerVMData : IDiceBoardGamesData
{
    [LabelColumn]
    ...
    public DiceBoardGamesMultiplayerVMData(IGamePackageResolver resolver, CommandContainer command)
    {
        _resolver = resolver;
        _command = command;
    }
