...
[SingletonGame]
[UseLabelGrid]
public partial class BasicMultiplayerDiceGamesVMData : IBasicDiceGamesData<SimpleDice>
{
    [LabelColumn]
    ...
    public BasicMultiplayerDiceGamesVMData(IGamePackageResolver resolver, CommandContainer command)
    {
        _resolver = resolver;
        _command = command;
    }
