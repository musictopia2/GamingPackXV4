namespace AlternationSolitaire.Blazor.Views;
public partial class AlternationSolitaireMainView
{
    private readonly BasicList<LabelGridModel> _labels = new();
    protected override void OnInitialized()
    {
        _labels.Clear();
        _labels.AddLabel("Score", nameof(AlternationSolitaireMainViewModel.Score)); //if there are others, do here.
        base.OnInitialized();
    }
