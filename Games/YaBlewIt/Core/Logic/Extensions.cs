...
{
    public static BasicList<int> GetContainedNumbers(this IEnumerable<YaBlewItCardInformation> list)
    {
    ...
    public static int TotalPoints(this DeckRegularDict<YaBlewItCardInformation> list, YaBlewItPlayerItem player)
    {
