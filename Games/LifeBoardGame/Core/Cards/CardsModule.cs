...
public static class CardsModule
{
    ...
    {
        CareerInfo thisCard = new() { Deck = deck, DegreeRequired = false };
        switch (deck)
        {
            case 1:
                {
            ...
            default:
                {
                    throw new CustomBasicException("Must be between 1 and 9; not " + deck);
                }
        }
        return thisCard;
    }
    public static HouseInfo GetHouseCard(int deck)
    {
        ...
        switch (deck)
        {
            ...
            default:
                {
                    throw new CustomBasicException("Must be between 10 and 18; not " + deck);
                }
        }
        return thisCard;
    }
    public static SalaryInfo GetSalaryCard(int deck)
    {
        ...
        switch (deck)
        {
            ...
            default:
                {
                    throw new CustomBasicException("Must be between 19 and 27; not " + deck);
                }
        }
        return thisCard;
    }
    public static StockInfo GetStockCard(int deck)
    {
        if (deck < 28 || deck > 36)
        {
            throw new CustomBasicException("Must be between 28 and 36; not " + deck);
        }
        int newNum;
        newNum = deck - 27;
    ...
    public static TileInfo GetTileInfo(int deck)
    {
        switch (deck)
        {
            ...
            default:
                {
                    throw new CustomBasicException("Must be between 1 and 25; not " + deck);
                }
        }
    }
}
