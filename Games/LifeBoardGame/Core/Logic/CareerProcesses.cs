...
public class CareerProcesses : ICareerProcesses
{
    ...
    private static bool PrivateCanGetSalary(string career1, string career2)
    {
        if (career1 != "Teacher")
        {
            return true;
    ...
    public void LoadCareerList() //if it does not load the career list, then rethink
    {
        ...
        DeckRegularDict<CareerInfo> tempList = new();
        ...
        {
            _model.HandList.AutoSelect = EnumHandAutoType.SelectAsMany;
        }
    }
}