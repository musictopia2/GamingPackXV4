...
{
    public static BasicList<BasicList<RegularSimpleCard>> PossibleCombinations(this IDeckDict<RegularSimpleCard> thisList, EnumRegularColorList whatColor)
    {
        return thisList.PossibleCombinations(whatColor, 3);
    }
    public static BasicList<BasicList<RegularSimpleCard>> PossibleCombinations(this IDeckDict<RegularSimpleCard> thisList, EnumRegularColorList whatColor, int maxs)
    {
