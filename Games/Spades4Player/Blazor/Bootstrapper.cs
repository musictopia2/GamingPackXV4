...
public class Bootstrapper : MultiplayerBasicBootstrapper<Spades4PlayerShellViewModel>
{
    ...
    {
        register.RegisterType<Spades4PlayerShellViewModel>(); //has to use interface part to make it work with source generators.
