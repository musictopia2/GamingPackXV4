...
{
    extension(IDeckDict<A8RoundRummyCardInformation> cardList)
    {
        private A8RoundRummyCardInformation GetLastCard(IDeckDict<A8RoundRummyCardInformation> newList)
        {
            if (cardList.Count != 8 && newList.Count != 7)
            {
                throw new CustomBasicException("The original list must have 8 cards and the new list must have 7 cards");
            }
            return cardList.Single(card =>
            {
                return newList.ObjectExist(card.Deck) == false;
            });
        }
        public bool HasRummy(A8RoundRummyMainGameClass mainGame) //you have to send one more argument
        {
            if (cardList.Count != 8)
            {
        ...
        private bool IsStraightColorOnly(IDeckDict<A8RoundRummyCardInformation> straightList, A8RoundRummyMainGameClass mainGame, int reverses)
        {
        ...
        private bool IsStraightShapeOnly(IDeckDict<A8RoundRummyCardInformation> straightList, A8RoundRummyMainGameClass mainGame, int reverses)
        {
        ...
        private bool IsStraightBoth(IDeckDict<A8RoundRummyCardInformation> straightList, A8RoundRummyMainGameClass mainGame, int reverses)
        {
        ...
        public bool GuaranteedVictory(A8RoundRummyMainGameClass mainGame)
        {
            mainGame.LastSuccessful = false;
            mainGame.LastCard = null;
