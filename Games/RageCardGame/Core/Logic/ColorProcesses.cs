...
public class ColorProcesses : IColorProcesses
{
    ...
    public async Task ColorChosenAsync()
    {
        ...
        {
            throw new CustomBasicException("Nobody is closing colors.  Rethink");
        }
        await _delgates.CloseColorScreenAsync.Invoke();
        await _model.TrickArea1!.ColorChosenAsync(_model.ColorChosen);
    }
    public async Task LoadColorListsAsync()
    {
        ...
        {
            throw new CustomBasicException("Must be choosing color");
        }
        ...
        {
            throw new CustomBasicException("Nobody is loading colors.  Rethink");
        }
