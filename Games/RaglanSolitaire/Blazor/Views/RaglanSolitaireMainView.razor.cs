namespace RaglanSolitaire.Blazor.Views;
public partial class RaglanSolitaireMainView
{
    private readonly BasicList<LabelGridModel> _labels = new();
    protected override void OnInitialized()
    {
        _labels.Clear();
        _labels.AddLabel("Score", nameof(RaglanSolitaireMainViewModel.Score)); //if there are others, do here.
        base.OnInitialized();
    }
