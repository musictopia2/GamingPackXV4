...
{
    public static AttackResultModel GetAttackResults(this RiskGameContainer container)
    {
        int attackLoss = 0;
        int defenseLoss = 0;
    ...
    public static void PopulatePlaceArmies(this RiskGameContainer container)
    {
    ...
    public static void PopulateMoveArmies(this RiskGameContainer container)
    {
    ...
    public static void PopulateAttackArmies(this RiskGameContainer container, int howMany)
    {
    ...
    public static void PopulateInstructions(this RiskGameContainer container)
    {
    ...
    private static int NextSetExtraReenforcements(this int setsReturned)
    {
        if (setsReturned == 1)
        {
            return 4;
    ...
    public static string GetNextReenforcementLabel(this RiskGameContainer container)
    {
    ...
    public static int RiskCardsReturnedExtraReenforcements(this RiskGameContainer container)
    {
    ...
    public static bool CanReturnRiskCards(this IBasicList<RiskCardInfo> cards) //hopefully works.
    {
        if (cards.Count < 3)
        {
