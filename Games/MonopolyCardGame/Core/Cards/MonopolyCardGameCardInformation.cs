namespace MonopolyCardGame.Core.Cards;
public class MonopolyCardGameCardInformation : SimpleDeckObject, IDeckObject, IComparable<MonopolyCardGameCardInformation>
{
    ...
    private static int FindIndex(int chosen)
    {
        ...
        switch (chosen)
        {
            ...
            default:
                {
                    throw new CustomBasicException("Does not go this high");
                }
        }
    }
    public void Populate(int chosen)
    {
        ...
        {
            throw new CustomBasicException("Cannot find the card information for deck " + chosen);
        }
        Deck = chosen;
        CardValue = indexs;
        switch (indexs)
