namespace CarpetSolitaire.Blazor;
public class Bootstrapper : SinglePlayerBootstrapper<CarpetSolitaireShellViewModel>
{
    ...
    {
        register.RegisterType<CarpetSolitaireShellViewModel>(); //has to use interface part to make it work with source generators.
