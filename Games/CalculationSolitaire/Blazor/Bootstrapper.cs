namespace CalculationSolitaire.Blazor;
public class Bootstrapper : SinglePlayerBootstrapper<CalculationSolitaireShellViewModel>
{
    ...
    {
        register.RegisterType<CalculationSolitaireShellViewModel>(); //has to use interface part to make it work with source generators.
