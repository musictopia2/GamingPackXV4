...
public static class Extensions
{
    extension(PlayerCollection<LifeCardGamePlayerItem> list)
    {
        ...
        {
            var newList = list.Where(items => items.PlayerCategory != EnumPlayerCategory.Self).ToBasicList();
        ...
        public bool HasYears => list.Any(thisPlayer => thisPlayer.MainHandList.Any(thisCard => thisCard.Points == 0));
        public async Task RepositionCardsAsync(LifeCardGameMainGameClass mainGame, LifeCardGameGameContainer gameContainer, LifeCardGameVMData model)
        {
            bool rets;
        ...
        public void EnableLifeStories(LifeCardGameMainGameClass mainGame, LifeCardGameVMData model, bool enables)
        {
