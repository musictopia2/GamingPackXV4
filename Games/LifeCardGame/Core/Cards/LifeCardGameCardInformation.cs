namespace LifeCardGame.Core.Cards;
public class LifeCardGameCardInformation : SimpleDeckObject, IDeckObject, IComparable<LifeCardGameCardInformation>
{
    ...
    public EnumSpecialCardCategory Requirement { get; set; }
    public EnumSpecialCardCategory SpecialCategory { get; set; }
    public EnumFirstCardCategory Category { get; set; }
    public string Description { get; set; } = "";
    public bool OpponentKeepsCard { get; set; }
    public EnumSwitchCategory SwitchCategory { get; set; }
    public EnumSwitchCategory CardToSwitch { get; set; }
    public bool CanBeInPlayerHandToBeginWith { get; set; }
    ...
    public void Populate(int chosen)
    {
                        ...
                        case 1:
                            {
                                switch (y)
                                {
                                    ...
                                    default:
                                        {
                                            throw new CustomBasicException("Don't know what to do about this career card");
                                        }
                                }
                                break;
                            }
                        case 2:
                            {
                                switch (y)
                                {
                                    ...
                                    default:
                                        {
                                            throw new CustomBasicException("Don't know what to do about this family card");
                                        }
                                }
                                break;
                            }
                        case 3:
                            {
                                switch (y)
                                {
                                    ...
                                    default:
                                        {
                                            throw new CustomBasicException("Don't know what to do about this adventure card");
                                        }
                                }
                                break;
                            }
                        case 4:
                            {
                                switch (y)
                                {
                                    ...
                                    default:
                                        {
                                            throw new CustomBasicException("Don't know what to do about this wealth card");
                                        }
                                }
                                break;
                            }
        ...
        throw new CustomBasicException("Can't find the deck " + Deck);
    }
    public void Reset() { }
