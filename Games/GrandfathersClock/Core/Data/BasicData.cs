namespace GrandfathersClock.Core.Data;
[SingletonGame]
public class BasicData : IGameInfo, ISolitaireData
{
    ...
    string IGameInfo.GameName => "Grandfather's Clock"; //replace with real name.
