...
internal static class RandomExtensions
{
    ...
    extension (GameTieredDistribution<int> tiers)
    {
        public GameTieredDistribution<int> Initialize(int phase, int repeats)
        {
            if (repeats > 3)
            {
                if (phase == 6)
        ...
        public GameTieredDistribution<int> PopulateVeryLuckTier(int phase, int repeats)
        {
            if (phase == 8)
            {
        ...
        public GameTieredDistribution<int> PopulateSomewhatLuckyTier(int phase, int repeats)
        {
            if (phase == 8)
            {
        ...
        public GameTieredDistribution<int> PopulateAverageTier(int phase, int repeats)
        {
            if (phase == 8)
            {
        ...
        public GameTieredDistribution<int> PopulateBadLuckTier(int phase, int repeats)
        {
        ...
        private void PopulateColorsVeryLucky(int repeats)
        {
        ...
        private void PopulateColorsSomewhatLucky(int repeats)
        {
        ...
        private void PopulateColorsAverage(int repeats)
        {
        ...
        private void PopulateColorsBadLuck(int repeats)
        {
        ...
        private void PopulateRunsVeryLucky(int repeats)
        {
            tiers.SelectTier(LuckStaticClass.Lucky, tiers =>
            {
                var list = GetWilds;
        ...
        private void PopulateRunsSomewhatLucky(int repeats)
        {
            tiers.SelectTier(LuckStaticClass.SomewhatLucky, tiers =>
            {
                var list = GetWilds;
        ...
        private void PopulateRunsAverage(int repeats)
        {
            tiers.SelectTier(LuckStaticClass.Average, tiers =>
            {
                var list = GetWilds;
        ...
        private void PopulateRunsBadLuck(int repeats)
        {
            tiers.SelectTier(LuckStaticClass.Bad, tiers =>
            {
                var list = GetWilds;
        ...
        private void PopulateTwoSetsOfFourVeryLucky(int repeats)
        {
            tiers.SelectTier(LuckStaticClass.Lucky, tiers =>
            {
        ...
        private void PopulateTwoSetsOfFourSomewhatLucky(int repeats)
        {
            tiers.SelectTier(LuckStaticClass.SomewhatLucky, tiers =>
            {
        ...
        private void PopulateTwoSetsOfFourAverage(int repeats)
        {
            tiers.SelectTier(LuckStaticClass.Average, tiers =>
            {
        ...
        private void PopulateTwoSetsOfFourBadLuck(int repeats)
        {
            tiers.SelectTier(LuckStaticClass.Bad, tiers =>
            {
        ...
        private void PopulateLastPhasesSomewhatLucky(int repeats)
        {
            tiers.SelectTier(LuckStaticClass.SomewhatLucky, tiers =>
            {
        ...
        private void PopulateLastPhasesBadLuck(int repeats)
        {
            tiers.SelectTier(LuckStaticClass.Bad, tiers =>
            {
        ...
        private void PopulateLastPhasesVeryLucky(int repeats)
        {
            tiers.SelectTier(LuckStaticClass.Lucky, tiers =>
            {
                // Wild weight based on repeats for Very Lucky
        ...
        private void PopulateLastPhasesAverage(int repeats)
        {
            tiers.SelectTier(LuckStaticClass.Average, tiers =>
            {
        ...
        private void PopulateRegularVeryLucky(int repeats)
        {
            tiers.SelectTier(LuckStaticClass.Lucky, tiers =>
            {
                var list = GetWilds;
        ...
        private void PopulateRegularSomewhatLucky(int repeats)
        {
            tiers.SelectTier(LuckStaticClass.SomewhatLucky, tiers =>
            {
                var list = GetWilds;
        ...
        private void PopulateRegularAverage(int repeats)
        {
            tiers.SelectTier(LuckStaticClass.Average, tiers =>
            {
                var list = GetWilds;
        ...
        private void PopulateRegularBadLuck(int repeats)
        {
            tiers.SelectTier(LuckStaticClass.Bad, tiers =>
            {
                var list = GetWilds;
