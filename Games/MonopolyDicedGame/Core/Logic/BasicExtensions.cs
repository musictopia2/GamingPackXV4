...
{
    extension (OwnedModel own)
    {
        public int IncompleteValue
        {
            get
            {
                if (own.WasChance)
    ...
    extension (EnumBasicType card)
    {
        public int MonopolyValue
        {
            get
            {
                if (card == EnumBasicType.Railroad)
                {
                    return 2500;
                }
                if (card == EnumBasicType.Utility)
                {
                    return 800;
                }
