...
internal static class MiscRollExtensions
{
    ...
    {
        private int NewCopsFound(IRandomGenerator randoms)
        {
            ...
            if (rollNumber == 0)
            {
                return 0; //the first roll is guaranteed to have o cops.
            }
        ...
        public BasicList<EnumMiscType> GetMiscResults(IRandomGenerator randoms)
        {
